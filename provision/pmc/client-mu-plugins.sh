...
LOCAL_DEV_HELPER_PATH="${PUBLIC_DIR_PATH}/wp-content/client-mu-plugins/000-localdev-helper.php"
...
if [ -d "${CLIENT_MU_PLUGINS_DIR}" ] && [ ! -f "${LOCAL_DEV_HELPER_PATH}" ]; then
  cp "${PMC_PROVISION_PATH}/pmc/templates/client-mu-plugins-dev-helper.php" "${LOCAL_DEV_HELPER_PATH}"
fi
